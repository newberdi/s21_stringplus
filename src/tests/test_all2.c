...
START_TEST(s21_memset_test) {
  unsigned char test1[10] = "Jonny err";
...
START_TEST(s21_strncat_test) {
  ...
  ck_assert_str_eq(s21_strncat(test_3, test_4, 0), "5");
}
END_TEST
...
//   result = s21_sscanf("%123 1.55 2", "%%%f %f", &a, &b);
//   result_origin = sscanf("%123 1.55 2", "%%%f %f", &c, &d);
